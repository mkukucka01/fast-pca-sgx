...
static const oe_ecall_info_t _fast_pca_ecall_info_table[] = 
{
    { "enclave_DotProduct_aa" },
    { "enclave_DotProduct_vv" },
...
oe_result_t fast_pca_enclave_DotProduct_aa(
    ...
    size_t len)
{
    ...
    /* Marshalling struct. */
    enclave_DotProduct_aa_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    OE_ADD_SIZE(_input_buffer_size, sizeof(enclave_DotProduct_aa_args_t));
    if (A)
    ...
    OE_ADD_SIZE(_output_buffer_size, sizeof(enclave_DotProduct_aa_args_t));
    ...
    _pargs_in = (enclave_DotProduct_aa_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (A)
        OE_WRITE_IN_PARAM(A, _args.len, sizeof(double*), double**);
    if (B)
        OE_WRITE_IN_PARAM(B, _args.len, sizeof(double*), double**);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fast_pca_ecall_info_table[fast_pca_fcn_id_enclave_DotProduct_aa].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (enclave_DotProduct_aa_args_t*)_output_buffer;
...
OE_WEAK_ALIAS(fast_pca_enclave_DotProduct_aa, enclave_DotProduct_aa);

oe_result_t fast_pca_enclave_DotProduct_vv(
    oe_enclave_t* enclave,
    double* _retval,
    double* A,
    double* B,
    ...
    size_t len)
{
    ...
    /* Marshalling struct. */
    enclave_DotProduct_vv_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(enclave_DotProduct_vv_args_t));
    if (A)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.len, sizeof(double));
    if (B)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.len, sizeof(double));
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(enclave_DotProduct_vv_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (enclave_DotProduct_vv_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (A)
        OE_WRITE_IN_PARAM(A, _args.len, sizeof(double), double*);
    if (B)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fast_pca_ecall_info_table[fast_pca_fcn_id_enclave_DotProduct_vv].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (enclave_DotProduct_vv_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(fast_pca_enclave_DotProduct_vv, enclave_DotProduct_vv);
    ...
    size_t len2)
{
    ...
    /* Marshalling struct. */
    enclave_DotProduct_av_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(enclave_DotProduct_av_args_t));
    if (A)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (enclave_DotProduct_av_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (A)
        OE_WRITE_IN_PARAM(A, _args.len1, sizeof(double*), double**);
    if (v)
        OE_WRITE_IN_PARAM(v, _args.len2, sizeof(double), double*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fast_pca_ecall_info_table[fast_pca_fcn_id_enclave_DotProduct_av].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (enclave_DotProduct_av_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(fast_pca_enclave_DotProduct_av, enclave_DotProduct_av);

oe_result_t fast_pca_enclave_CenterMatrix(
    oe_enclave_t* enclave,
    double** result,
    double** A,
    int n,
    ...
    size_t len)
{
    ...
    /* Marshalling struct. */
    enclave_CenterMatrix_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fast_pca_ecall_info_table[fast_pca_fcn_id_enclave_CenterMatrix].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (enclave_CenterMatrix_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(fast_pca_enclave_CenterMatrix, enclave_CenterMatrix);

oe_result_t fast_pca_enclave_CovarianceMatrix(
    oe_enclave_t* enclave,
    double** cov,
    double** A,
    int n,
    ...
    size_t len)
{
    ...
    /* Marshalling struct. */
    enclave_CovarianceMatrix_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fast_pca_ecall_info_table[fast_pca_fcn_id_enclave_CovarianceMatrix].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (enclave_CovarianceMatrix_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fast_pca_ecall_info_table[fast_pca_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(fast_pca_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t fast_pca_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    oe_report_buffer_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fast_pca_ecall_info_table[fast_pca_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(fast_pca_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t fast_pca_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fast_pca_ecall_info_table[fast_pca_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(fast_pca_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t fast_pca_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fast_pca_ecall_info_table[fast_pca_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(fast_pca_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t fast_pca_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fast_pca_ecall_info_table[fast_pca_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(fast_pca_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);
...
static oe_ocall_func_t _fast_pca_ocall_function_table[] = {
...
oe_result_t oe_create_fast_pca_enclave(
    const char* path,
