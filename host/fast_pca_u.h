 ...
 */
#ifndef EDGER8R_FAST_PCA_U_H
#define EDGER8R_FAST_PCA_U_H

#include <openenclave/host.h>

#include "fast_pca_args.h"
...
/**** ECALL prototypes. ****/
oe_result_t enclave_DotProduct_aa(
    oe_enclave_t* enclave,
    double* _retval,
    double** A,
    double** B,
...
oe_result_t enclave_DotProduct_vv(
    oe_enclave_t* enclave,
    double* _retval,
    double* A,
    double* B,
...
oe_result_t enclave_CenterMatrix(
    oe_enclave_t* enclave,
    double** result,
    double** A,
    int n,
