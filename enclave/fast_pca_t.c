...
enum
{
    ...
    fast_pca_fcn_id_oe_get_sgx_report_ecall = 3,
    fast_pca_fcn_id_oe_get_report_v2_ecall = 4,
    fast_pca_fcn_id_oe_verify_local_report_ecall = 5,
    fast_pca_fcn_id_oe_sgx_init_context_switchless_ecall = 6,
    fast_pca_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall = 7,
